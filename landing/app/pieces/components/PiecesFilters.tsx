...
export default function PiecesFilters() {
  ...
  return (
    <>
      ...
      <form 
        method="get"
        className="w-full lg:w-1/4 mb-10 lg:mb-0 p-4 py-0 overflow-y-auto bg-white dark:bg-gray-800 hidden lg:block"
        tabIndex={-1}
        aria-labelledby="drawer-label"
      >
        <h5 className="inline-flex w-full py-4 bg-white justify-between items-center mb-4 mb-0 text-base font-semibold !text-gray-500 uppercase bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white">
          Filter Pieces
        </h5>
        
        <div className="lg:!flex flex-col justify-between flex-1">
            ...
            <div className="space-y-2">
              ...
              {categories.map((category, index) => (
                <div key={category.value} className="flex items-center">
                  ...
                  />
                  <label
                    htmlFor={`category-desktop-${index}`}
