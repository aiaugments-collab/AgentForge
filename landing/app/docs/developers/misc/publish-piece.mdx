...
4. You will be asked three questions to publish your piece:
  ...
  - `API URL`: This is the URL of the API endpoint where the piece will be published (ex: https://cloudagent.augment.cfd/api).
...
? Enter the API URL : https://cloudagent.augment.cfd/api
