            ...
            <div className="h-[calc(100vh-73px)] overflow-y-auto p-4 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
                ...
                <nav className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="mb-3">
                      ...
                      <div className="space-y-1">
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="text-sm font-semibold text-gray-900">AgentForge 101</div>
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="text-sm font-semibold text-gray-900">AI Use Cases</div>
                            <div className="text-xs text-gray-500">See AI automation in action</div>
                          </div>
                          <svg className="w-3 h-3 text-gray-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                          </svg>
                        ...
                        >
                          ...
                          <div>
                            <div className="text-sm font-semibold text-gray-900">Community Tutorials</div>
                            <div className="text-xs text-gray-500">Learn from other users</div>
                          </div>
                        </a>
                      </div>
                    </div>
                    ...
                    {/* Support */}
                    <div>
                      <h4 className="text-xs font-semibold text-gray-500 mb-1">Support</h4>
                      <div className="space-y-1">
                        <a
                          ...
                          className="flex items-start gap-2 p-1.5 rounded-lg hover:bg-gray-50 group/item"
                        >
                          <div className="w-6 h-6 flex items-center justify-center rounded-lg bg-green-50 group-hover/item:bg-green-100 transition-colors">
                            <svg className="w-3 h-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z"></path>
                            </svg>
                          </div>
                          <div>
                            <div className="text-sm font-semibold text-gray-900">Forum</div>
                            <div className="text-xs text-gray-500">Chat with other users</div>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div>
                            <div className="text-sm font-semibold text-gray-900">Discord</div>
                            <div className="text-xs text-gray-500">Join our live community</div>
                          </div>
                        </a>
                        <a
                          href="/blog"
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-500">Latest news and updates</div>
                          </div>
                        </a>
                      </div>
                    </div>
