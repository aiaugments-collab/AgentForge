...
The platform is the admin panel for managing your instance. It's suitable for SaaS, Embed, or agencies that want to white-label AgentForge and offer it to their customers. With this platform, you can:
...
3. **Piece Management:** Take full control over AgentForge pieces. You can show or hide existing pieces and create your own unique pieces to customize the platform according to your specific needs.
