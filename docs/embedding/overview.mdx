...
This section provides an overview of how to embed the AgentForge builder in your application and automatically provision the user.
...
<Steps>
    ...
    <Step title="Embed Builder">
        You can use the SDK to embed and customize AgentForge in your SaaS, read more [here](./embed-builder).
    </Step>
</Steps>

   
   Here is an example of how it looks like in one of the SaaS that embed AgentForge: 
