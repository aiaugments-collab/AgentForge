...
<Info>
**Requirements:**
* AgentForge version 0.34.5 or higher
...
<Warning>
**Breaking Change:** <br/><br/> If your AgentForge instance version is < 0.45.0 and (you are using the connect method from the embed sdk, and need the connection externalId to be returned after the user creates it OR if you want to reconnect a specific connection with an externalId), you must upgrade your instance to >= 0.45.0
</Warning>

- You can use the embedded SDK in your SaaS to allow your users to create connections and store them in AgentForge.
