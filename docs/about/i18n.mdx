...
AgentForge uses Crowdin because it helps translators who don't know how to code. It also makes the approval process easier. AgentForge automatically sync new text from the code and translations back into the code.
