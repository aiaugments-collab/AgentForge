...
title: "Overview"
icon: "hand-wave"
description: "Introduction to the different ways to install AgentForge"
---

AgentForge Community Edition can be deployed using **Docker**, **Docker Compose**, and **Kubernetes**.
...
Deploy AgentForge as a single Docker container using the SQLite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="./options/docker-compose">
    Deploy AgentForge with **Redis** and **PostgreSQL** setup.
  </Card>
...
<CardGroup cols={2}>
  <Card title="AgentForge Cloud" icon="cloud" color="##5155D7" href="https://cloud.activepieces.com/">
