...
<Steps>
    ...
    <Step title="Fill in the Client ID & Client Secret in AgentForge"></Step>
...
<Steps>
    ...
    <Step title="Copy the Client ID and Client Secret and fill them in AgentForge"></Step>
    <Step title="Click Finish"></Step>
</Steps>
...
<Steps>
    ...
    <Step title="Fill in Audience URI (SP Entity ID) with 'AgentForge'"></Step>
...
<Steps>
    ...
    <Step title="Copy the ACS URL from AgentForge and paste it in the ACS urls">
